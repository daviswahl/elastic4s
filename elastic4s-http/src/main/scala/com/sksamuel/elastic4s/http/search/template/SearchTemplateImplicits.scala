...
trait SearchTemplateImplicits {
  ...
  implicit object TemplateSearchExecutable
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], req: TemplateSearchDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object RemoveSearchTemplateExecutable
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], req: RemoveSearchTemplateDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object PutSearchTemplateExecutable
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], req: PutSearchTemplateDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
      val endpoint = "/_scripts/" + req.name
  ...
  implicit object GetSearchTemplateExecutable
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], req: GetSearchTemplateDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
      val endpoint = "/_scripts/" + req.name
