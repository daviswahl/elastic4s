...
trait IndexImplicits extends IndexShowImplicits {
  ...
  implicit object IndexHttpExecutable extends HttpExecutable[IndexDefinition, IndexResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: IndexDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object GetIndexHttpExecutable extends HttpExecutable[GetIndex, Map[String, GetIndexResponse]] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: GetIndex)(implicit E: FromListener[F,E]): F[HttpResponse] = {
