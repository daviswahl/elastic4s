...
trait NodesImplicits {
  ...
  implicit object NodeInfoExecutable extends HttpExecutable[NodeInfoDefinition, NodeInfoResponse] {
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: NodeInfoDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object NodeStatsExecutable extends HttpExecutable[NodeStatsDefinition, NodesStatsResponse] {
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: NodeStatsDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
