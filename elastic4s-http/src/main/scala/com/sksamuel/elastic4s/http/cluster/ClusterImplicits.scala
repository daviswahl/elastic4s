...
trait ClusterImplicits {
  ...
  implicit object ClusterStateHttpExecutable extends HttpExecutable[ClusterStateDefinition, ClusterStateResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: ClusterStateDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object ClusterHealthHttpExecutable extends HttpExecutable[ClusterHealthDefinition, ClusterHealthResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: ClusterHealthDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
