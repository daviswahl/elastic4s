...
trait SearchImplicits {
  ...
  implicit object MultiSearchHttpExecutable extends HttpExecutable[MultiSearchDefinition, MultiSearchResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: MultiSearchDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object SearchHttpExecutable extends HttpExecutable[SearchDefinition, SearchResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: SearchDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
