...
trait SettingsImplicits {
  ...
  implicit object GetSettingsHttpExecutable extends HttpExecutable[GetSettingsDefinition, IndexSettingsResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: GetSettingsDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object UpdateSettingsHttpExecutable extends HttpExecutable[UpdateSettingsDefinition, IndexSettingsResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: UpdateSettingsDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
