...
trait SearchScrollImplicits {
  ...
  implicit object ClearScrollHttpExec extends HttpExecutable[ClearScrollDefinition, ClearScrollResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: ClearScrollDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object SearchScrollHttpExecutable extends HttpExecutable[SearchScrollDefinition, SearchResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], req: SearchScrollDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
