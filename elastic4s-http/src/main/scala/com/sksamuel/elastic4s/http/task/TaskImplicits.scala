...
trait TaskImplicits {
  ...
  implicit object ListTaskHttpExecutable extends HttpExecutable[ListTasksDefinition, ListTaskResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: ListTasksDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object CancelTaskHttpExecutable extends HttpExecutable[CancelTasksDefinition, Boolean] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: CancelTasksDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
