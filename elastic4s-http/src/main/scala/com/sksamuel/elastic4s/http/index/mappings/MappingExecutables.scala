...
trait MappingExecutables {
  ...
  implicit object GetMappingHttpExecutable extends HttpExecutable[GetMappingDefinition, Seq[IndexMappings]] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: GetMappingDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object PutMappingHttpExecutable extends HttpExecutable[PutMappingDefinition, PutMappingResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: PutMappingDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
