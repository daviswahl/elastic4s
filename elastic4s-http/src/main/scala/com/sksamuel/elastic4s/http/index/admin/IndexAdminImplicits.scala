...
trait IndexAdminImplicits extends IndexShowImplicits {
  ...
  implicit object ShrinkIndexHttpExecutable extends HttpExecutable[ShrinkIndex, ShrinkIndexResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: ShrinkIndex)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object IndexRecoveryHttpExecutable extends HttpExecutable[IndexRecoveryDefinition, IndexRecoveryResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: IndexRecoveryDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object ForceMergeHttpExecutable extends HttpExecutable[ForceMergeDefinition, ForceMergeResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: ForceMergeDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object FlushIndexHttpExecutable extends HttpExecutable[FlushIndex, FlushIndexResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: FlushIndex)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object ClearCacheHttpExecutable extends HttpExecutable[ClearCache, ClearCacheResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: ClearCache)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object IndexExistsHttpExecutable extends HttpExecutable[IndicesExists, IndexExistsResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: IndicesExists)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object GetSegmentHttpExecutable extends HttpExecutable[GetSegments, GetSegmentsResponse] {
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: GetSegments)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object TypeExistsHttpExecutable extends HttpExecutable[TypesExists, TypeExistsResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: TypesExists)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object AliasExistsHttpExecutable extends HttpExecutable[AliasExistsDefinition, AliasExistsResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: AliasExistsDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object OpenIndexHttpExecutable extends HttpExecutable[OpenIndex, OpenIndexResponse] {
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: OpenIndex)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object CloseIndexHttpExecutable extends HttpExecutable[CloseIndex, CloseIndexResponse] {
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: CloseIndex)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object RefreshIndexHttpExecutable extends HttpExecutable[RefreshIndex, RefreshIndexResponse] {
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: RefreshIndex)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object CreateIndexHttpExecutable extends HttpExecutable[CreateIndexDefinition, CreateIndexResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: CreateIndexDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object DeleteIndexHttpExecutable extends HttpExecutable[DeleteIndex, DeleteIndexResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: DeleteIndex)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object UpdateIndexLevelSettingsExecutable extends HttpExecutable[UpdateIndexLevelSettingsDefinition, UpdateIndexLevelSettingsResponse] {
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: UpdateIndexLevelSettingsDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
  ...
  implicit object IndexShardStoreExecutable extends HttpExecutable[IndexShardStoreDefinition, StoreStatusResponse] {
    ...
    override def execute[F[_], E](client: HttpRequestClient[F,E], request: IndexShardStoreDefinition)(implicit E: FromListener[F,E]): F[HttpResponse] = {
